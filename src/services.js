...
import image1 from './imgservice.png'
import image2 from './im2.png'
class Services extends Component {
    render() {
        return ( <div id="services" class="py-3 bg-white">
        <div class="container ">
               <div class="row">
                   ...
                   <div class="col col-lg-6 my-4">
                    ...
                    <div class="col-lg-3 ">
                         ...
                         <div class="col-lg-3">
                  <img class="service-card-img  position-relative mb-2" src={image1} alt=""/></div>
   ...
   <div class="service-card service-card-doctors bg-primary rounded">
       ...
       <div class="service-card-content">
                  <img class="service-card-imgg position-relative py-5   "src={image2} alt=""/>   
       </div>
       </div>
         </div>
         </div>
